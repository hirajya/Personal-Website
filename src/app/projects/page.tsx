...
const projects = [
  {
    ...
    description:
      "A full-stack e-commerce solution built with React, Node.js, and MongoDB. Features user authentication, payment integration, and admin dashboard.",
  ...
  },
  {
    ...
    description:
      "A responsive weather dashboard with location-based forecasting, interactive maps, and historical weather data visualization.",
  ...
  },
  {
    ...
    description:
      "A secure, transparent voting system built on blockchain technology ensuring tamper-proof elections and voter anonymity.",
  ...
  },
  {
    ...
    description:
      "A comprehensive analytics platform for social media managers to track engagement, growth metrics, and audience insights across multiple platforms.",
    technologies: [
      "Django",
      "Python",
      "Redis",
