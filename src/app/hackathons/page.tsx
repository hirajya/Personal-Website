...
const hackathons = [
  {
    ...
    duration: "48 hours",
    description: "Built an AI-powered financial advisor app that helps users make informed investment decisions using real-time market data and machine learning algorithms.",
    project: "FinanceAI Assistant",
    technologies: ["React Native", "Python", "TensorFlow", "Firebase", "Alpha Vantage API"],
  ...
  },
  {
    ...
    location: "Virtual",
    duration: "36 hours",
    description: "Developed a sustainable transportation app that gamifies eco-friendly commuting and connects users with carpooling opportunities.",
    project: "EcoCommute",
    technologies: ["Flutter", "Node.js", "MongoDB", "Google Maps API", "Socket.io"],
  ...
  },
  {
    ...
    location: "Houston, TX",
    duration: "48 hours",
    description: "Created a Mars terrain visualization tool using satellite data to help mission planners identify optimal landing sites for future Mars expeditions.",
  ...
  },
  {
    ...
    duration: "60 hours",
    description: "Built an immersive VR education platform that allows students to explore historical events and scientific concepts in virtual reality environments.",
    project: "HistoryVR",
  ...
  },
  {
    ...
    duration: "72 hours",
    description: "Developed a decentralized supply chain tracking system to ensure transparency and authenticity in organic food distribution.",
    project: "FarmChain",
  ...
  },
  {
    ...
    location: "Boston, MA",
    duration: "48 hours",
    description: "Created a mental health support app using AI to provide personalized meditation sessions and mood tracking with real-time feedback.",
    project: "MindfulAI",
    technologies: ["React Native", "Express.js", "PostgreSQL", "OpenAI API", "Chart.js"],
  ...
  },
  {
    ...
    location: "Campus",
    duration: "24 hours",
    description: "My first hackathon experience! Built a simple campus event discovery app to help students find and join activities happening around university.",
...
const categories = ["All", "AI/ML", "Sustainability", "Space Tech", "VR/AR", "Blockchain", "HealthTech", "Web App"];

export default function HackathonsPage() {
  const [selectedCategory, setSelectedCategory] = React.useState("All");
  const [timelineView, setTimelineView] = React.useState(false);
  const [activeHackathon, setActiveHackathon] = React.useState<number | null>(null);

  const filteredHackathons = selectedCategory === "All" 
    ? hackathons 
    : hackathons.filter(hackathon => hackathon.category === selectedCategory);
  ...
  return (
    <div className="min-h-screen bg-gray-900">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-flex items-center px-4 py-2 rounded-full border border-gray-600 bg-gray-800/50 backdrop-blur-sm mb-8">
                  ...
                  <span className="text-gray-300 text-sm font-medium">Innovation Challenges</span>
                </div>
                ...
                <p className="text-xl text-gray-400 mb-8 max-w-lg leading-relaxed">
                  Competitive programming meets innovation. Building breakthrough solutions under pressure.
                </p>

                {/* Stats */}
                <div className="grid grid-cols-3 gap-6 mb-8">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-white mb-1">{hackathons.length}</div>
                    <div className="text-gray-400 text-sm">Events</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-white mb-1">{hackathons.filter(h => h.achievement.includes("Place") || h.achievement.includes("Winner")).length}</div>
                    <div className="text-gray-400 text-sm">Awards</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-white mb-1">{hackathons.reduce((total, h) => total + h.teamSize, 0)}</div>
                ...
                <div className="flex items-center gap-6">
                  <button 
                    onClick={() => document.getElementById('featured-hackathons')?.scrollIntoView({ behavior: 'smooth' })}
              ...
              <div className="relative">
                <div className="aspect-square relative">
                  <Image
                    ...
                    style={{ clipPath: 'polygon(0 0, 85% 0, 100% 85%, 15% 100%)' }}
                  />
      ...
      <section id="featured-hackathons" className="py-24 px-4 md:px-8 lg:px-16 xl:px-32">
            ...
            {featuredHackathons.map((hackathon) => (
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
                  <div className={`lg:col-span-7 ${hackathon.id % 2 === 0 ? 'lg:order-2' : ''}`}>
                    <div className="relative aspect-[4/3] overflow-hidden bg-gray-800">
                      ...
                      <div className={`absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 ${
                        activeHackathon === hackathon.id ? 'translate-y-0' : 'translate-y-4'
                      }`}>
                  ...
                  <div className={`lg:col-span-5 ${hackathon.id % 2 === 0 ? 'lg:order-1' : ''}`}>
                    <div className="space-y-6">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-300 mb-2">Project: {hackathon.project}</h4>
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-gray-700">
                        <div className="text-green-400 font-bold text-lg">{hackathon.prize}</div>
                        <div className="text-yellow-400 font-medium">{hackathon.achievement}</div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-12">
              A comprehensive timeline of innovation challenges and breakthrough solutions
            </p>
          ...
          {timelineView ? (
            ...
            <div className="relative">
              ...
              {filteredHackathons.map((hackathon) => (
                <div key={hackathon.id} className={`relative flex items-center mb-12 ${hackathon.id % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                  <div className={`w-full md:w-5/12 ${hackathon.id % 2 === 0 ? 'md:pr-8' : 'md:pl-8'}`}>
                    <div className="bg-gray-50 p-6 shadow-lg border border-gray-200 hover:shadow-xl transition-shadow duration-300">
                      ...
                      <p className="text-gray-600 text-sm mb-3">{hackathon.location} • {hackathon.duration}</p>
                      <h4 className="font-semibold text-gray-800 mb-2">{hackathon.project}</h4>
                      <p className="text-gray-600 text-sm mb-4">{hackathon.description}</p>
                      <div className="flex items-center justify-between">
                        <span className="px-2 py-1 bg-yellow-100 text-yellow-800 text-xs font-medium">{hackathon.achievement}</span>
                        <span className="text-green-600 font-semibold text-sm">{hackathon.prize}</span>
                      </div>
                    </div>
                  </div>
